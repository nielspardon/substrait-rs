...
## [0.65.0](https://github.com/nielspardon/substrait-rs/compare/v0.64.1...v0.65.0) - 2026-08-26

### Added

- *(deps,substrait)* [**breaking**] bump substrait from `0.87.0` to `0.102.0` ([#531](https://github.com/nielspardon/substrait-rs/pull/531))
...
- [**breaking**] use packaged substrait-prost and substrait-extensions crates ([#507](https://github.com/substrait-io/substrait-rs/pull/507))
...
- *(deps,cargo)* bump the cargo group across 1 directory with 6 updates ([#379](https://github.com/substrait-io/substrait-rs/pull/379))
...
- *(deps,cargo)* [**breaking**] bump msrv to 1.85.1 and cargo group across 1 directory with 7 updates ([#358](https://github.com/substrait-io/substrait-rs/pull/358))
...
- *(deps,cargo)* [**breaking**] bump typify from 0.4.0 to 0.4.1 in the cargo group ([#338](https://github.com/substrait-io/substrait-rs/pull/338))
- *(deps,cargo)* bump syn from 2.0.100 to 2.0.101 in the cargo group ([#336](https://github.com/substrait-io/substrait-rs/pull/336))
...
- *(deps,cargo)* bump prettyplease from 0.2.31 to 0.2.32 in the cargo group ([#323](https://github.com/substrait-io/substrait-rs/pull/323))
- fix clippy 1.86 warning in generated code ([#324](https://github.com/substrait-io/substrait-rs/pull/324))

## [0.55.0](https://github.com/substrait-io/substrait-rs/compare/v0.54.1...v0.55.0) - 2025-03-17

### Other

- *(deps,cargo)* bump prettyplease from 0.2.30 to 0.2.31 in the cargo group ([#317](https://github.com/substrait-io/substrait-rs/pull/317))

## [0.54.1](https://github.com/substrait-io/substrait-rs/compare/v0.54.0...v0.54.1) - 2025-03-10

### Other

- *(deps,cargo)* bump the cargo group with 2 updates ([#316](https://github.com/substrait-io/substrait-rs/pull/316))
- *(deps,cargo)* bump the cargo group with 2 updates ([#314](https://github.com/substrait-io/substrait-rs/pull/314))
- *(deps,cargo)* bump the cargo group with 3 updates ([#312](https://github.com/substrait-io/substrait-rs/pull/312))
- *(deps,cargo)* bump schemars from 0.8.21 to 0.8.22 in the cargo group ([#308](https://github.com/substrait-io/substrait-rs/pull/308))

## [0.54.0](https://github.com/substrait-io/substrait-rs/compare/v0.53.2...v0.54.0) - 2025-02-20

### Other

- *(deps,cargo)* bump the cargo group with 2 updates (#305)
 ...
 * **[#283](https://github.com/substrait-io/substrait-rs/issues/283)**
    - Bump regress from 0.10.2 to 0.10.3 in the cargo group ([`48b7ea6`](https://github.com/substrait-io/substrait-rs/commit/48b7ea636fb6779e68c65ef3035f26f6e0db61cd))
</details>
 ...
 * **[#282](https://github.com/substrait-io/substrait-rs/issues/282)**
    - Bump the cargo group with 2 updates ([`747d7f1`](https://github.com/substrait-io/substrait-rs/commit/747d7f1b0f5245c38cc55f822b725f16543ad53c))
 * **Uncategorized**
    - Release substrait v0.52.2 ([`8f341ce`](https://github.com/substrait-io/substrait-rs/commit/8f341ce0c93530891a051f96126ef7dfbf90ddb4))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.52.1 ([`b963b44`](https://github.com/substrait-io/substrait-rs/commit/b963b440a45e706a2932d7c47a67ba4fbe21963f))
</details>
 ...
 * **[#279](https://github.com/substrait-io/substrait-rs/issues/279)**
    - Bump the cargo group with 2 updates ([`64c5d17`](https://github.com/substrait-io/substrait-rs/commit/64c5d17c5282469ed69212f59082e367bdb04dcc))
 * **Uncategorized**
    - Release substrait v0.51.4 ([`eee71e7`](https://github.com/substrait-io/substrait-rs/commit/eee71e756a857ceab9bb7682b865705ad52e05a6))
</details>
 ...
 * **[#278](https://github.com/substrait-io/substrait-rs/issues/278)**
    - Bump the cargo group with 2 updates ([`c82bd0d`](https://github.com/substrait-io/substrait-rs/commit/c82bd0d23ba26d198f6cc7e87f4f2b9da3da1b88))
 * **Uncategorized**
    - Release substrait v0.51.3 ([`d12cab4`](https://github.com/substrait-io/substrait-rs/commit/d12cab405158c0b445acc5dbbc57689cc2046229))
</details>
 ...
 * **[#277](https://github.com/substrait-io/substrait-rs/issues/277)**
    - Bump syn from 2.0.94 to 2.0.95 in the cargo group ([`dddc15f`](https://github.com/substrait-io/substrait-rs/commit/dddc15f86e44cd0d365d13e74a1cd53a025d2443))
 * **Uncategorized**
    - Release substrait v0.51.2 ([`d0945cd`](https://github.com/substrait-io/substrait-rs/commit/d0945cd0123e2cb39667e196b410a610242bcd54))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.51.1 ([`7c274ae`](https://github.com/substrait-io/substrait-rs/commit/7c274aec6648ac1c10cd3f675ca1f542ff3a0b40))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.50.4 ([`9e2109b`](https://github.com/substrait-io/substrait-rs/commit/9e2109be564d3e59d5122fa3e8210f848b5e5d0c))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.50.1 ([`bbcc9f6`](https://github.com/substrait-io/substrait-rs/commit/bbcc9f6d0b084a13706f39a43bbba9d37bf2a959))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.49.2 ([`1e87e93`](https://github.com/substrait-io/substrait-rs/commit/1e87e9372e5f1a5afe383dcb805a393e69e084b7))
</details>
...
### Chore
 ...
 - <csr-id-800b5e15c35387ba80cc9071c17223c2ba981396/> bump serde_json from 1.0.132 to 1.0.133 in the cargo group
   Bumps the cargo group with 1 update:
   [serde_json](https://github.com/serde-rs/json).
 ...
 * **[#253](https://github.com/substrait-io/substrait-rs/issues/253)**
    - Bump serde_json from 1.0.132 to 1.0.133 in the cargo group ([`800b5e1`](https://github.com/substrait-io/substrait-rs/commit/800b5e15c35387ba80cc9071c17223c2ba981396))
 * **Uncategorized**
    - Release substrait v0.48.1 ([`4c27611`](https://github.com/substrait-io/substrait-rs/commit/4c27611373613b43628e101dae7f5a0aa5b0125b))
</details>
 ...
 * **[#252](https://github.com/substrait-io/substrait-rs/issues/252)**
    - Bump substrait from `0.60.0` to `0.61.0` ([`746e5bc`](https://github.com/substrait-io/substrait-rs/commit/746e5bc7b321cdb82d52297339330d717c3c0f8e))
 * **Uncategorized**
    - Release substrait v0.48.0 ([`33c8312`](https://github.com/substrait-io/substrait-rs/commit/33c8312ab3cea291bbd378fd26a287260fe40c45))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.47.2 ([`ba3e38d`](https://github.com/substrait-io/substrait-rs/commit/ba3e38df7bc6a298e7e4d382685aa6c6f8b91c85))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.47.0 ([`69be8a6`](https://github.com/substrait-io/substrait-rs/commit/69be8a631c84de6696e4546e49f48559948c4d54))
</details>
 ...
 * **[#245](https://github.com/substrait-io/substrait-rs/issues/245)**
    - Bump substrait from `0.58.0` to `0.59.0` ([`cb6e276`](https://github.com/substrait-io/substrait-rs/commit/cb6e276eb71882a7c13e3142de526f720ab64d60))
 * **Uncategorized**
    - Release substrait v0.46.0 ([`428dd4c`](https://github.com/substrait-io/substrait-rs/commit/428dd4c0a2911a315aa7e69196c7f56268632842))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.45.5 ([`9243673`](https://github.com/substrait-io/substrait-rs/commit/924367300c5ab5d6b4fed9a34495d9dfaa5aa369))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.44.1 ([`8e760b1`](https://github.com/substrait-io/substrait-rs/commit/8e760b19dc94571ea42d83c53e7c6fcef106d16d))
</details>
 ...
 * **[#233](https://github.com/substrait-io/substrait-rs/issues/233)**
    - Bump the cargo group across 1 directory with 3 updates ([`26c1d05`](https://github.com/substrait-io/substrait-rs/commit/26c1d05548bf501db6a556f53f3aeb6f16c3abd6))
 * **Uncategorized**
    - Release substrait v0.42.5 ([`f7a089b`](https://github.com/substrait-io/substrait-rs/commit/f7a089b233cbec52ffa70df539918fbc35aef6fd))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.42.4 ([`f2bc018`](https://github.com/substrait-io/substrait-rs/commit/f2bc0184d0741c1cf0800591d72adaddbf2af0ea))
</details>
 ...
 * **[#228](https://github.com/substrait-io/substrait-rs/issues/228)**
    - Revert bump once_cell from 1.19.0 to 1.20.0 in the cargo group ([`783dae3`](https://github.com/substrait-io/substrait-rs/commit/783dae3f6e8c8951bb7cd8fa80ee6c766486b387))
 * **Uncategorized**
    - Release substrait v0.42.2 ([`aa74cf3`](https://github.com/substrait-io/substrait-rs/commit/aa74cf34d8bb04c23a69ada37d6c65c95dc03d98))
</details>
 ...
 * **[#226](https://github.com/substrait-io/substrait-rs/issues/226)**
    - Bump once_cell from 1.19.0 to 1.20.0 in the cargo group ([`2d3d64d`](https://github.com/substrait-io/substrait-rs/commit/2d3d64d56c9765d018c604ba0e622063cf1941ec))
 * **Uncategorized**
    - Release substrait v0.42.1 ([`6ee7a0f`](https://github.com/substrait-io/substrait-rs/commit/6ee7a0f97e4ab48cf430b2ce18f3f75611db100c))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.42.0 ([`93724c3`](https://github.com/substrait-io/substrait-rs/commit/93724c3b557031a5031a04dac7c28b4102badd1c))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.41.8 ([`d793b47`](https://github.com/substrait-io/substrait-rs/commit/d793b47a78f6c8c03e6ec6545f3640c7d6012ad4))
</details>
 ...
 * **[#220](https://github.com/substrait-io/substrait-rs/issues/220)**
    - Bump the proto group with 3 updates ([`8cb516e`](https://github.com/substrait-io/substrait-rs/commit/8cb516eb592d2434e7813f4fd4184a78f32ab76e))
 * **Uncategorized**
    - Release substrait v0.41.6 ([`172ea80`](https://github.com/substrait-io/substrait-rs/commit/172ea80237498f639a9a956c8b3e8344126208d3))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.41.5 ([`b9ad85a`](https://github.com/substrait-io/substrait-rs/commit/b9ad85a9a55b6104c960911ff72e4f519326b603))
</details>
...
<csr-id-46c09e7243b2f3b9039e992fbc35c7ff5359bf68/>
 ...
 * **Uncategorized**
    - Release substrait v0.41.0 ([`cda2b69`](https://github.com/substrait-io/substrait-rs/commit/cda2b69e7cb7baa451eacfe593ef8ff797bad871))
</details>
...
### Other (BREAKING)
 ...
 - <csr-id-16ead9630ca2618e8931584c9d88c50ade94e2ff/> upgrade prost to 0.13 for hyper 1.x
...
<csr-id-444f9613a2895a10e26099c31ca1394d7991b42f/>

### Chore (BREAKING)

 - <csr-id-444f9613a2895a10e26099c31ca1394d7991b42f/> bump substrait from `0.50.0` to `0.51.0`
   Bumps [substrait](https://github.com/substrait-io/substrait) from
 ...
 * **[#194](https://github.com/substrait-io/substrait-rs/issues/194)**
    - Bump substrait from `0.50.0` to `0.51.0` ([`444f961`](https://github.com/substrait-io/substrait-rs/commit/444f9613a2895a10e26099c31ca1394d7991b42f))
 * **Uncategorized**
    - Release substrait v0.36.0 ([`6fa602d`](https://github.com/substrait-io/substrait-rs/commit/6fa602d91ec4659c3f9900e4437fc41beaf22d53))
</details>

## 0.35.0 (2024-07-01)

<csr-id-e6b70410ab3bc1e915865695fbb0a52176772b28/>

### Chore (BREAKING)

 - <csr-id-e6b70410ab3bc1e915865695fbb0a52176772b28/> bump substrait from `0.49.0` to `0.50.0`
   Bumps [substrait](https://github.com/substrait-io/substrait) from
   `fcf0f76` to `7dbbf04`.
 ...
 * **[#193](https://github.com/substrait-io/substrait-rs/issues/193)**
    - Bump substrait from `0.49.0` to `0.50.0` ([`e6b7041`](https://github.com/substrait-io/substrait-rs/commit/e6b70410ab3bc1e915865695fbb0a52176772b28))
 * **Uncategorized**
    - Release substrait v0.35.0 ([`ccb05f3`](https://github.com/substrait-io/substrait-rs/commit/ccb05f36eed33b1d563d01d0c30638f090e8a9a0))
</details>
 ...
 * **Uncategorized**
    - Release substrait v0.34.1 ([`d11b22c`](https://github.com/substrait-io/substrait-rs/commit/d11b22c743df9b02b7e5f4c079091ed133982431))
</details>
...
### Chore (BREAKING)
 ...
 - <csr-id-90241f5e0e962395b3d1721bc83a07aef1de317b/> bump substrait from `0.47.0` to `0.48.0`
   Bumps [substrait](https://github.com/substrait-io/substrait) from
   `9cba028` to `3dc77ae`.
...
<csr-id-25a14ec1c75ff3120ba244756a7f317c9a93a0a3/>

### Chore (BREAKING)

 - <csr-id-25a14ec1c75ff3120ba244756a7f317c9a93a0a3/> bump substrait from `0.46.0` to `0.47.0`
   Bumps [substrait](https://github.com/substrait-io/substrait) from
   `1a51b3d` to `9cba028`.
 ...
 * **[#178](https://github.com/substrait-io/substrait-rs/issues/178)**
    - Bump substrait from `0.46.0` to `0.47.0` ([`25a14ec`](https://github.com/substrait-io/substrait-rs/commit/25a14ec1c75ff3120ba244756a7f317c9a93a0a3))
 * **Uncategorized**
    - Release substrait v0.31.0 ([`825c0df`](https://github.com/substrait-io/substrait-rs/commit/825c0df204707629fda4f5ab2901ce5ae7143ee5))
</details>

## 0.30.0 (2024-04-15)

<csr-id-bb78a157f0b67d88b54e29253d1f2543a0ae81bf/>
 ...
 * **Uncategorized**
    - Release substrait v0.30.0 ([`cac007c`](https://github.com/substrait-io/substrait-rs/commit/cac007c63bdaba53139a13fce48476668709e041))
</details>
...
### Chore
 ...
 - <csr-id-7d80f71db452297292f5c39f36824923d48e6692/> bump actions/configure-pages from 4 to 5
   Bumps
...
<csr-id-c3ba665f78036a830ee38266ed8ca01c2ed18086/>
<csr-id-12945c54c10f82d8eabb775691bb5348de39306e/>
 ...
 * **Uncategorized**
    - Release substrait v0.28.0 ([`f4a175e`](https://github.com/substrait-io/substrait-rs/commit/f4a175e9e4f1bdffdee15c30a78f130445da366a))
